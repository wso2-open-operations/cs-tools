...
export const ACTION_REQUIRED_CHANGE_REQUEST_STATUS_IDS = [5, 1];

export const OUTSTANDING_CASE_STATUS_IDS = [1, 10, 18, 1003, 6, 1006];
export const OUTSTANDING_CONVERSATIONS_STATUS_IDS = [1, 2];
export const OUTSTANDING_CHANGE_REQUESTS_STATUS_IDS = [5, -2, -1, 0, 1];
export const OUTSTANDING_SERVICE_REQUESTS_STATUS_IDS = [1, 10, 18, 1003, 6, 1006];

export const RESOLVED_STATUS_IDS = [3];

export const STATUS_ALLOWING_RESOLUTION = ["1", "10", "1003", "6", "18", "1006"];
export const STATUS_ALLOWING_REJECTION = ["6", "18"];
export const STATUS_ALLOWING_RELATED_CASE = ["3"];
