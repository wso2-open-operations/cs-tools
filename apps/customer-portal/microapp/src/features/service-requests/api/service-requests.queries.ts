...
import { getAllServiceRequests, getServiceRequest } from "@features/service-requests/api/service-requests.api";
...
export const serviceRequests = {
  ...
  all: (id: string, body: GetCasesRequestDto = {}) =>
    queryOptions({ queryKey: ["service-requests", id, body], queryFn: () => getAllServiceRequests(id, body) }),
