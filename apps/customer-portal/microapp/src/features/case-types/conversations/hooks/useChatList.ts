...
import type { GetChatsRequestDto } from "@features/case-types/conversations/types/chat.dto";

export function useChatList(projectId: string, filters: GetChatsRequestDto["filters"]) {
