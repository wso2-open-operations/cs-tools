...
export function ProfileSettingsView({ me, timeZones, mutation, buildPayload }: ProfileSettingsViewProps) {
  const formik = useFormik<UpdateProfileFormValues>({
    ...
    onSubmit: async (values, { setSubmitting }) => {
      try {
        await mutation.mutateAsync(buildPayload(values.phoneNumber, values.timeZone));
      } finally {
        setSubmitting(false);
      }
    },
