...
/**
 * Skeleton placeholder matching the case details UI: case ID, severity, status chip, title, avatar and engineer row, tabs, panel.
 *
...
export default function CaseDetailsSkeleton(): JSX.Element {
  return (
    <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
      ...
      {/* Panel content - placeholder text only, no skeleton */}
