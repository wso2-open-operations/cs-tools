...
import ChangeRequestCard from "@features/support/components/request-cards/ChangeRequestCard";
import { CHANGE_REQUEST_BULLET_ITEMS } from "@features/operations/constants/changeRequestConstants";

// Mock the child component to isolate the test
vi.mock("@features/support/components/request-cards/RequestCard", () => ({
  default: ({
    title,
    subtitle,
    bulletItems,
