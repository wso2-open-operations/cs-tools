...
// ---------------------------------------------------------------------------
// Backend-shaped types (mirror csm-portal-backend updates types.go).
// Kept alongside the UI types above so v2's CsmUpdatesPage + api hooks
// continue to compile against the real BFF contract.
// ---------------------------------------------------------------------------
