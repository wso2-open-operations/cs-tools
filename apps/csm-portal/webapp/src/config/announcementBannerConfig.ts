...
export const announcementBannerConfig: AnnouncementBannerConfig = {
  visible: window.config?.CSM_PORTAL_ANNOUNCEMENT_BANNER_VISIBLE ?? false,
  storageKey:
    window.config?.CSM_PORTAL_ANNOUNCEMENT_BANNER_STORAGE_KEY ??
    "announcement_banner_v1",
  html: window.config?.CSM_PORTAL_ANNOUNCEMENT_BANNER_HTML ?? "",
};
