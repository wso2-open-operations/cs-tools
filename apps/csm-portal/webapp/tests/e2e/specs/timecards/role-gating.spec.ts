...
// which resolves isApprover from GET /users/me roles (csm-leads /
// csm-timecard-admins). Approvers see it; plain engineers do not, even when the
// tab is forced via the URL.
//
