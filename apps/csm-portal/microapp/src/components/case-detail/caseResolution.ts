...
export const RESOLUTION_CODES: CaseResolutionCode[] = [
...
export const CASE_CAUSES: CaseCause[] = [
...
/** Title-cases an UPPER_SNAKE_CASE backend enum value, e.g. "SOLVED_BY_CUSTOMER" -> "Solved by customer". */
