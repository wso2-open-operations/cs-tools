...
func main() {
	...
	mux.HandleFunc("POST /cases/{caseId}/call-requests/{callRequestId}/schedule", caseHandler.ScheduleCallRequest)
	mux.HandleFunc("POST /cases/{caseId}/call-requests/{callRequestId}/reject", caseHandler.RejectCallRequest)
	mux.HandleFunc("POST /cases/{caseId}/call-requests/{callRequestId}/notes", caseHandler.SendCallRequestNotes)
