...
// when a non-2xx response is received, so callers can map upstream status
// codes to appropriate handling. Copied from csm-notification-service to keep
// the error convention identical across services.
package apierror
