...
func main() {
	...
	kbDraftConsumerGroup := envOrDefault("KB_DRAFT_CONSUMER_GROUP", "csm-notification-service-kb-draft")
	kbDraftConsumerCount := envInt("KB_DRAFT_CONSUMER_COUNT", 1)
	kbDraftConsumers := startConsumers(ctx, "kb-draft", eventBusCfg, kbDraftConsumerGroup, kbDraftConsumerCount, kbDraftEngine.Handle, toDeadLetter)
