...
func TestValidate_Valid(t *testing.T) {
	cases := map[string]struct {
		...
		"engagement.status_update_created":      {"SU-1", TypeEngagementStatusUpdateCreated, `{"engagementId":"ENG-1","subject":"Weekly update","content":"<p>body</p>","recipients":["author@wso2.com"],"ccRecipients":["team@wso2.com"]}`},
	}
...
func TestValidate_RequiresFields(t *testing.T) {
	cases := map[string]struct {
		...
		"engagement.status_update_created missing subject": {"SU-1", TypeEngagementStatusUpdateCreated, `{"engagementId":"ENG-1","content":"<p>body</p>","recipients":["author@wso2.com"]}`},
		"engagement.status_update_created missing content": {"SU-1", TypeEngagementStatusUpdateCreated, `{"engagementId":"ENG-1","subject":"Weekly update","recipients":["author@wso2.com"]}`},
		"engagement.status_update_created no recipients":   {"SU-1", TypeEngagementStatusUpdateCreated, `{"engagementId":"ENG-1","subject":"Weekly update","content":"<p>body</p>","recipients":[]}`},
