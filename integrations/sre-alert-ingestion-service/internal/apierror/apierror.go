...
// when a non-2xx response is received, allowing callers to map upstream
// status codes to appropriate handling (e.g. the worker's retry/escalate
// decision, or a handler's HTTP response).
package apierror
