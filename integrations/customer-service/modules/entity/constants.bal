...
# default record limits for pagination.
public const int DEFAULT_RECORD_LIMIT = 100;

# default record offset for pagination.
public const int DEFAULT_RECORD_OFFSET = 0;
