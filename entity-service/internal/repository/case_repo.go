...
type CaseRepository interface {
	...
	// GetCaseByID returns the case with the given UUID, or a NotFoundError if
...
func (r *caseRepo) GetCaseByID(ctx context.Context, id string) (domain.Case, error) {
	var c domain.Case
	...
	if err != nil {
		return domain.Case{}, fmt.Errorf("get case by id: %w", err)
	}
	return c, nil
}
