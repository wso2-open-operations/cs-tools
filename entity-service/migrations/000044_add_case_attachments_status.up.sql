...
-- Adds an upload lifecycle to case_attachment. Today, a row is only ever
...
-- comment above.
CREATE INDEX IF NOT EXISTS idx_case_attachment_status_created ON case_attachment(status, created_on);
